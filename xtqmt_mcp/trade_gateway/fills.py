...
def list_fills(
    ...
    *,
    ...
    order_index = _build_order_index(list(local_order_payload.get("rows", [])))
    merged_rows = _dedupe_trades(list(broker_trade_payload.get("rows", [])) + list(local_trade_payload.get("rows", [])))
