...
class TradeGatewayConfigTests(unittest.TestCase):
    def test_load_example_config(self) -> None:
        ...
        self.assertEqual(cfg.trade_ops.xtdata_port, 0)
        self.assertEqual(cfg.login.port_num, 0)
        self.assertEqual(cfg.trade_ops.kill_switch_file, r"C:\xtquant-mcp-example\instance\prod\control\trade_kill_switch.flag")
