...
class BundleAndConfigTests(unittest.TestCase):
    ...
    def test_load_trade_gateway_config(self) -> None:
        with _WorkspaceTempDir() as tmp:
            ...
            config_path.write_text(
                "\n".join(
                    [
                        ...
                        "  venv_path: C:\\xtquant-mcp-example\\venv313",
                        "bundle:",
                        "  bundle_root: C:\\xtquant-mcp-example\\vendor\\xtquant_250807",
                        "transport:",
                        "  bind_port: 9001",
                        "qmt:",
                        ...
                        "trade:",
                        "  account_id: ACC001",
                        "  output_dir: C:\\xtquant-mcp-example\\instance\\prod\\artifacts\\trade_ops",
                        "login:",
            ...
            self.assertEqual(cfg.qmt.qmt_exe, r"C:\QMT\XtMiniQmt.exe")
            ...
            config_path.write_text(
                "\n".join(
                    [
                        ...
                        "  bind_port: 9002",
                        "data:",
                        "  jobs_root: C:\\xtquant-mcp-example\\instance\\prod\\state\\data_jobs",
                        "  subscriptions_root: C:\\xtquant-mcp-example\\instance\\prod\\state\\subscriptions",
