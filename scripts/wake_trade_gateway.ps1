param(
    ...
    [string]$ConfigPath = "C:\xtquant-mcp-example\instance\prod\config\trade_gateway.local.yaml",
    [string]$PythonExe = "",
...
$ExpectedServerName = "xtqmtTradeGateway"
...
$runner = Join-Path $RepoRoot "scripts\run_trade_gateway_http.py"
...
$logDir = "C:\xtquant-mcp-example\instance\prod\logs\trade_gateway"
New-Item -ItemType Directory -Path $logDir -Force | Out-Null
$stamp = Get-Date -Format "yyyyMMdd_HHmmss"
$stdoutLog = Join-Path $logDir "trade_gateway_${stamp}.log"
$stderrLog = Join-Path $logDir "trade_gateway_${stamp}.stderr.log"
